          ...
          <div className="fixed inset-0 flex items-center justify-center z-50 p-5">
            ...
            >
              ...
              <div className="flex items-center justify-between mb-6">
                <h2 className="text-xl font-bold text-gray-900">{t('review.rate_offer_title', 'Rate this Offer')}</h2>
                <button
                  onClick={onClose}
              ...
              <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500">{t('review.share_experience_offer', 'Share your experience')}</p>
                </div>
              </div>
              ...
              <div className="text-center mb-6">
                ...
                {rating === 1 && <p className="text-gray-700 font-medium">{t('review.offer_star_1', 'Not worth it')}</p>}
                {rating === 2 && <p className="text-gray-700 font-medium">{t('review.offer_star_2', 'Could be better')}</p>}
                {rating === 3 && <p className="text-gray-700 font-medium">{t('review.offer_star_3', 'Good deal')}</p>}
                {rating === 4 && <p className="text-gray-700 font-medium">{t('review.offer_star_4', 'Great deal!')}</p>}
                {rating === 5 && <p className="text-gray-700 font-medium">{t('review.offer_star_5', 'Excellent deal!')}</p>}
              </div>

              {/* Comment */}
              <div className="mb-6">
                <label className="block text-sm font-medium text-gray-700 mb-2">
                  {t('review.your_review', 'Your Review')}
                </label>
                <textarea
                  value={comment}
                  onChange={(e) => setComment(e.target.value)}
                  placeholder={t('review.tell_others', 'Tell others about this offer...')}
                  rows={4}
