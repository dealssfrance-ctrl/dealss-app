  ...
  return (
    ...
    <div className="min-h-screen bg-gray-50 pb-24 md:pb-6">
      ...
      <div className="bg-white border-b border-gray-200 sticky top-0 z-10">
        <div className="px-5 md:px-8 lg:px-10 py-6">
          <div className="flex items-center justify-between max-w-7xl mx-auto">
            <h1 className="text-3xl font-bold text-gray-900 md:hidden">Dealss</h1>
      ...
      <motion.button
        ...
        className="fixed bottom-28 right-5 bg-[#1FA774] text-white w-14 h-14 rounded-full shadow-lg flex items-center justify-center z-20 hover:bg-[#18a689] transition-colors md:hidden"
      >
